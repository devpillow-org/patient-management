...
class Function(models.Model):  # type: ignore[misc]
...
def _user_get_permissions(
    user: Union[AbstractBaseUser, AnonymousUser], obj: Optional[Any], from_name: str
) -> Set[str]:
    permissions = set()
...
def _user_has_perm(
    user: Union[AbstractBaseUser, AnonymousUser], perm: str, obj: Optional[Any]
) -> bool:
    for backend in auth.get_backends():
...
def _user_has_module_perms(
    user: Union[AbstractBaseUser, AnonymousUser], app_label: str
) -> bool:
    for backend in auth.get_backends():
...
class PermissionsMixin(models.Model):  # type: ignore[misc]
...
class EmployeProfile(PermissionsMixin, ModelsBase):  # type: ignore[misc]
